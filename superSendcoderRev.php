        ...
        if (isset($_POST['email'])) {
            ...
            if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
                $error = 'Invalid email format.';
                 ...
                 $designation = trim($_POST['designation']); // Get designation
                ...
                if (empty($firstName) || empty($lastName)) {
                    ...
                    if (empty($password) || empty($rePassword)) {
                        ...
                        if ($stmt->execute([$verificationCode, $email, $hashedPassword])) {
                             ...
                             $_SESSION['suffix'] = $suffix; // Optional
...
<div class="container">
    ...
    <form method="POST" action="">
        ...
        <input type="text" id="middle_initial" name="middle_initial" maxlength="2" placeholder="Enter your middle initial">
