...
// Use the full server path for file operations
$upload_dir ='https://reoc.great-site.net/REOC/uploads/'; // This is best for move_uploaded_file, file_exists, etc.
...
<?php include 'navbar/navbar.php'; ?>
    ...
    if (success) {
        Swal.fire({
            ...
            window.location.href = 'Home_page.php'; // Redirect after the alert
        });
    }
    </script>
